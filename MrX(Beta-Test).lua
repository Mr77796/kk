...
local Window = Library.CreateLib("MrX(Beta-Test)", "RJTheme5")
...
Section:NewTextBox("JumpPower", "JumpPower", function(j) 
 ...
 Section:NewButton("Super Rings Parts v6", "Super Rings Parts v6", function()
     --[[
...
-- Just that enjoy skidding this lol
 ...
 Section:NewButton("Chilli Hub Sab", "Chilli Hub Sab", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/tienkhanh1/spicy/main/Chilli.lua"))()
 end)


 Section:NewButton("Animation R15", "Animation R15", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/1nJD7PkH",true))()
 end)


 Section:NewTextBox("print", "you can talk in develop log", function(p)
    print(p)
 end)
